...
// Array.pop()
// Remove the last element in our array, and it'll return that element
let shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges'];
shoppingList.pop();
console.log(shoppingList);
...
// Array.map()
// Transforms the element in the original array by calling the given function once for each element in the array 
let shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges'];
...
// Array.findIndex()
// Returns the index of the first element in an array that passes the test in a given function. Returns a -1 when the element is not found
let shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges'];
console.log(shoppingList.findIndex(item => item.startsWith('o')));

// Array.every()
// Checks if all elements in an array pass a test given as a function. If there is one element that returns a false value, the function returns false and does nto check the rest of the elements
let shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges'];
...
// Array.splice()
// Add/removes elements in an array and returns the removed elements. First argument takes in an integer that specififes at what index to add/remove the elements. Second argument takes in the number of items to be removed. Optional third argument takes in the new elements to be added to the array
let shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges'];
